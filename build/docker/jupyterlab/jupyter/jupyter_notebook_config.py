...
#  Default: ''
# c.NotebookApp.keyfile = u'/etc/letsencrypt/archive/workstation.debankurs.com/privkey1.pem'
...
#  Default: ''
# c.ServerApp.keyfile = '/etc/letsencrypt/live/workstation.debankurs.com/privkey.pem'
# c.ServerApp.certfile = '/etc/letsencrypt/live/workstation.debankurs.com/fullchain.pem'
...
#  Choices: any of ['sha1', 'sha384', 'sha3_384', 'sha3_224', 'sha256', 'sha3_512', 'blake2s', 'sha224', 'md5', 'sha3_256', 'sha512', 'blake2b']
#  Default: 'sha256'
